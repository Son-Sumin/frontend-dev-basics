...
// splice : 1. index에서 count개를 삭제하고, 삭제하고 남은 요소를 배열에 담아 반환
console.log("========splice(index, count)==========");
console.log(fruits);
var fruits2 = fruits.splice(0,2);  // index 0에서부터 2개를 삭제 
console.log(fruits2, fruits);

// splice : 2. index에서 count개를 삭제하고 replace(요소)로 대체한 후, 삭제하고 남은 요소를 배열에 담아 반환
...
console.log("========splice - removeAt() 처럼 작동==========");
var a1 = [0,1,2,3,4];
a1.splice(2,1);         // a1.removeAt(2)  ->  ex12.js 확인
console.log(a1);

// splice : 4. insertAt() 처럼 작동
console.log("========splice - insertAt() 처럼 작동==========");
var a1 = [0,1,2,3,4];
