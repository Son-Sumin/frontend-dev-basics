...
// Array.prototype.remove 생성 전에 실해하여 에러 발생
// var a = [1,2,4];
// a.remove(2); 
...
Array.prototype.insert = function(index, value) {
    if(value instanceof Array) {
        ...
        // }
        console.log("this: " + this);  // this(a): 1,2,4  ; string으로 풀려서 출력
        ...
        // 해결방법2 ; foreach문 사용할때 쓰기 [.bind() 사용]
        // 모든 함수는 Function.prototype.bind() 함수 사용 가능
        // 함수 실행 불록 안의 this를 세팅할 수 있다.
        // 위에서 local this로 인해 오류였지만, bind(this)는 a이기에 this.splice는 a로 세팅
        value.forEach(function(e){
            this.splice(index++, 0, e);
        }.bind(this) );
...
// [ 1, 2, 'a', 'b', 'c', 4 ] 출력하기 위해
// 1. Array.prototype.insert에 if문 내 for문 추가
